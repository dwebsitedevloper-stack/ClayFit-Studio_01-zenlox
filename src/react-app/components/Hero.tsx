      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-[48px] clay-shadow-lg p-12 md:p-16">
          ...
          <p className="text-xl md:text-2xl text-stone-600 max-w-3xl mx-auto mb-12 font-light leading-relaxed">
            Experience fitness reimagined with our minimal, modern approach to
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="group bg-gradient-to-br from-stone-900 to-neutral-800 text-white px-10 py-5 rounded-full clay-shadow-lg font-semibold text-lg hover-lift flex items-center gap-3"
            >
              Start Your Journey
            ...
            <a
              href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" // replace with your actual tour video link
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-white/90 backdrop-blur-sm text-stone-800 px-10 py-5 rounded-full clay-shadow font-semibold text-lg hover-lift flex items-center gap-3"
            >
        ...
        <div className="grid grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={stat.label}
              className="bg-white/60 backdrop-blur-xl rounded-3xl clay-shadow p-6 hover-lift"
            >
